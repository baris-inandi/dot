...
mode $mode_web {
  bindsym C exec --no-startup-id bash ~/dot/scripts/user/web.sh "Google Classroom" "https://classroom.google.com/u/1/h/"
  bindsym N exec --no-startup-id bash ~/dot/scripts/user/web.sh "Gmail (User 0)" "https://mail.google.com/mail/u/0/"
  bindsym M exec --no-startup-id bash ~/dot/scripts/user/web.sh "Gmail (User 1)" "https://mail.google.com/mail/u/1/"
